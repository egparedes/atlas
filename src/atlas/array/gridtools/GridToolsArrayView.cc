...
//            &( storage_info_ ) );
        ...
        auto stridest = StoragePropBuilder<storage_info_ty, Rank, std::make_integer_sequence<std::size_t, Rank>>::buildStrides(storage_info_);
        auto shapet = StoragePropBuilder<storage_info_ty, Rank, std::make_integer_sequence<std::size_t, Rank>>::buildShapes(storage_info_);
