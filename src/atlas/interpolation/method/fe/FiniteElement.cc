    ...
    for ( ElemIndex3::NodeList::const_iterator itc = elems.begin(); itc != elems.end(); ++itc ) {
        ...
        if ( nb_cols == 3 ) {
            ...
            element::Triag3D triag(
                PointXYZ{( *icoords_ )( idx[0], size_t(0) ), ( *icoords_ )( idx[0], size_t(1) ), ( *icoords_ )( idx[0], size_t(2) )},
                PointXYZ{( *icoords_ )( idx[1], size_t(0) ), ( *icoords_ )( idx[1], size_t(1) ), ( *icoords_ )( idx[1], size_t(2) )},
                PointXYZ{( *icoords_ )( idx[2], size_t(0) ), ( *icoords_ )( idx[2], size_t(1) ), ( *icoords_ )( idx[2], size_t(2) )} );
            ...
            element::Quad3D quad(
                ...
                PointXYZ{( *icoords_ )( idx[1], (size_t)0 ), ( *icoords_ )( idx[1], (size_t)1 ), ( *icoords_ )( idx[1], (size_t)2 )},
                PointXYZ{( *icoords_ )( idx[2], (size_t)0 ), ( *icoords_ )( idx[2], (size_t)1 ), ( *icoords_ )( idx[2], (size_t)2 )},
                PointXYZ{( *icoords_ )( idx[3], (size_t)0 ), ( *icoords_ )( idx[3], (size_t)1 ), ( *icoords_ )( idx[3], (size_t)2 )} );
